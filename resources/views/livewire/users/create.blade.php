                    ...
                    <div class="">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <div class="pl-4 form-group col-md-1">
                                <input type="radio" checked wire:model="gender" name="gender" class="form-check-input" value="yes">
                                <label for="iscompany_yes">{{ __('Male') }}</label>
                            </div>
                            <div class="pl-4 form-group col-md-1">
                                <input type="radio" wire:model="gender" name="gender" class="form-check-input" value="no">
