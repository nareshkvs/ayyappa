...
{
    public $isOpen = 0;
    public $name, $role_id, $role, $roles, $roleType;
    public $permissions = [];
    ...
    public function render()
    {
        ...
        ->select('roles.id', 'roles.name as role_name', 'type', DB::raw('group_concat(groups.name) as group_name'))
        ->groupByRaw('roles.id')
        ->orderBy('roles.name')
        ->get();
