    ...
    <div class="container px-4 mx-auto">
        ...
        <div class="w-1/2 mt-10 space-y-8 divide-y divide-gray-200">
            ...
            <div class="pt-5 sm:col-span-6">
                ...
                <div class="mt-1">
                    <textarea id="body" rows="3" wire:model="blog.body" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out bg-white border border-gray-300 border-gray-400 rounded-md shadow-sm appearance-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                </div>
            </div>
            <div class="sm:col-span-6">
                <label for="title" class="block text-sm font-medium text-gray-700">
                ...
                <div class="mt-1">
                    <input id="title" wire:model="blog.blog_photo_path" name="title" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out bg-white border border-gray-400 rounded-md appearance-none sm:text-sm sm:leading-5">
                </div>
            </div>
            <div class="sm:col-span-6">
                <label for="title" class="block text-sm font-medium text-gray-700">
                ...
                <div class="mt-1">
                    <input id="title" wire:model="blog.visibility" name="title" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out bg-white border border-gray-400 rounded-md appearance-none sm:text-sm sm:leading-5">
                </div>
            </div>
            <div class="sm:col-span-6">
                <label for="title" class="block text-sm font-medium text-gray-700">
                ...
                <div class="mt-1">
                    <input id="title" wire:model="blog.category" name="title" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out bg-white border border-gray-400 rounded-md appearance-none sm:text-sm sm:leading-5">
                </div>
            </div>
