...
class Users extends Component
{
    ...
    public $first_name, $last_name, $gender, $mobile, $user_id, $email, $bio, $isActive, $role, $password, $password_confirmation;
    public $user;
    public $roles = [];
    public $role_id = '';
    ...
    private function resetInputFields(){
        $this->reset(['first_name', 'last_name', 'user_id', 'role_id', 'email', 'gender', 'mobile']);
        $this->resetErrorBag();
        $this->resetValidation();
    }
