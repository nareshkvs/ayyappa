    ...
    <div class="max-w-6xl px-4 py-0 mx-auto ">
        ...
        >
            <ul class="flex border-b">
                ...
                <li @click="showManageFieldPermissions()" :class="{ '-mb-px': openTab === 3 }" class="">
                    <a :class="openTab === 3 ? activeClasses : inactiveClasses" class="inline-block px-4 py-2 font-semibold text-center rounded-t-lg" href="javascript:;">Manage Field Permissions</a>
                </li>
            </ul>
