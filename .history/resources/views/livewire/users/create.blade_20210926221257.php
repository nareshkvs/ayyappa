                ...
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <x-jet-input type="radio" class="block w-full mt-1" wire:model.defer="gender" /> Male
                            <x-jet-input type="radio" class="block w-full mt-1" wire:model.defer="gender" /> Female
