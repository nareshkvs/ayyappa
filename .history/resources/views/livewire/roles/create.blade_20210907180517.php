            ...
            <form>
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="block mb-2 text-sm font-bold text-gray-700">Type:</label>
                            <select id="roleType" name="roleType"
                                class="inline w-full py-2 pl-3 pr-10 mt-0 text-base border-gray-300 rounded-md focus:outline-none sm:text-sm"
                                wire:model="roleType">
                                <option value="Internal">Internal</option>
                                <option value="External">External</option>
                            </select>
                            @error('roleType') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4 ">
