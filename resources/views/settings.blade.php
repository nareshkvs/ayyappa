    ...
    <div class="p-1 bg-transparent">
        <div x-data="toggleTabs()">
            <ul class="flex flex-col sm:flex-row ">
                <li class="pt-2 pb-1 pr-1 rounded-md min-w-32"
                    x-bind:class="{ 'bg-gray-100 min-width:': tab === 'users' }">
                    <a href="javascript:;" :class="tab === 'users' ? activeClasses : inactiveClasses"
                        x-on:click="openUsersTab" class="block px-4 py-2 font-semibold text-center rounded-t-lg">Users</a>
                </li>
                <li class="pt-2 pb-1 pr-1 min-w-32" x-bind:class="{ 'bg-gray-100 -mb-px': tab === 'roles' }">
                    <a href="javascript:;" :class="tab === 'roles' ? activeClasses : inactiveClasses"
                        x-on:click="openRolesTab"
                        class="block px-4 py-2 font-semibold text-center rounded-t-lg">Roles</a>
                </li>
                <li class="pt-2 pb-1 pr-1 min-w-32" x-bind:class="{ 'bg-gray-100 -mb-px': tab === 'permissions' }">
                    <a href="javascript:;" :class="tab === 'permissions' ? activeClasses : inactiveClasses"
                        x-on:click="openPermissionsTab"
                        class="block px-4 py-2 font-semibold text-center rounded-t-lg">Permissions</a>
                </li>
                <li class="pt-2 pb-1 pr-1 min-w-32" x-bind:class="{ 'bg-gray-100 -mb-px': tab === 'groups' }">
                    <a href="javascript:;" :class="tab === 'groups' ? activeClasses : inactiveClasses"
                        x-on:click="openGroupsTab"
                        class="block px-4 py-2 font-semibold text-center rounded-t-lg">Groups</a>
                </li>
            </ul>
